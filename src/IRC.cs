...
#region constructors
        ...
        public IRC(String server, int port, String mainNick, String backupNick, String chan, int randomTalkPercent, int retry, bool useDirectAnswerLine, String incomingIdent, String incomingRealName)
        {
