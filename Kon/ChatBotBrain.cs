...
////////////////////////////////////////////////
// TO DO: Get this fully updated to work with //
// Kon version 2.0.                           //
////////////////////////////////////////////////
...
#region variables
        ...
        public         bool         answerSearch             = true;
        public  static Filter       filter;
        private        string       BRAIN_FILE               = "chatbot.brain";
        ...
        public ChatBotBrain(bool answerSearch)
        {
...
#region Add To Brain
        public void addToBrain(string conversation, string nick)
        {
            ...
            if (conversation != "")
            {
                brain = new StreamWriter(KON_BRAIN, true);
